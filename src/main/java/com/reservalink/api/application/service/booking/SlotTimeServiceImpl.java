...
public class SlotTimeServiceImpl implements SlotTimeService {
    ...
    public SlotTimeServiceImpl(SlotTimeRepository slotTimeRepository, ModelMapper modelMapper, OfferingRepository offeringRepository, BookingRepository bookingRepository, ResourceRepositoryPort resourceRepositoryPort) {
    ...
    public List<SlotTimeResponse> createList(List<SlotTimeRequest> slotTimeRequestList) {
        ...
        ResourceEntity resourceEntity = resourceRepositoryPort.findById(slotTimeRequestList.get(0).getResourceId())
