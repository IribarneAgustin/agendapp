...
public interface BookingRepository extends JpaRepository<BookingEntity, String> {
        ...
        @Query("""
                        ...
                        WHERE st.id = :slotTimeId
                          ...
                          AND st.enabled = true
                        """)
        Integer getIncomingBookingsCountBySlotId(@Param("slotTimeId") String slotTimeId,
                        @Param("now") LocalDateTime now);

        List<BookingEntity> findBySlotTimeEntityStartDateTimeBetweenAndStatusAndEnabledTrue(LocalDateTime start,
        ...
        @Query("""
                        ...
                        """)
        Integer getIncomingBookingsCountByResourceId(@Param("resourceId") String resourceId,
                        @Param("now") LocalDateTime now);

        List<BookingEntity> findByBookingPackageIdAndStatus(String bookingPackageId, BookingStatus status);
}
